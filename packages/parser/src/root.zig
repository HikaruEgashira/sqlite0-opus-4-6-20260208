...
pub const Parser = struct {
    ...
    fn classifyScalarFunc(name: []const u8) ?ScalarFunc {
        const funcs = .{
            ...
            .{ "CEIL", ScalarFunc.ceil_fn },
            .{ "CEILING", ScalarFunc.ceil_fn },
            .{ "FLOOR", ScalarFunc.floor_fn },
            .{ "SQRT", ScalarFunc.sqrt_fn },
            .{ "POWER", ScalarFunc.power_fn },
            .{ "POW", ScalarFunc.power_fn },
            .{ "LOG", ScalarFunc.log_fn },
            .{ "LOG10", ScalarFunc.log_fn },
            .{ "LOG2", ScalarFunc.log2_fn },
            .{ "LN", ScalarFunc.ln_fn },
            .{ "EXP", ScalarFunc.exp_fn },
            .{ "ACOS", ScalarFunc.acos_fn },
            .{ "ASIN", ScalarFunc.asin_fn },
            .{ "ATAN", ScalarFunc.atan_fn },
            .{ "ATAN2", ScalarFunc.atan2_fn },
            .{ "COS", ScalarFunc.cos_fn },
            .{ "SIN", ScalarFunc.sin_fn },
